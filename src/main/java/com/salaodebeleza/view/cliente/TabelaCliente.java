...
public class TabelaCliente extends JInternalFrame {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -1775744442415195111L;
	...
	private void initComponents() {
		...
		btnIncluir.setIcon(new ImageIcon(TabelaCliente.class.getResource("/com/salaodebeleza/estrutura/imagens/book_add.png")));
		...
		btnSair.setIcon(new ImageIcon(TabelaCliente.class.getResource("/com/salaodebeleza/estrutura/imagens/sair.png")));
		...
		btnPesquisar.setIcon(new ImageIcon(TabelaCliente.class.getResource("/com/salaodebeleza/estrutura/imagens/search.png")));
		...
		btnPrimeiro.setIcon(new ImageIcon(TabelaCliente.class.getResource("/com/salaodebeleza/estrutura/imagens/go-first.png")));
		
		btnAnterior = new JButton("");
		
		btnAnterior.setToolTipText("Anterior");
		btnAnterior.setIcon(new ImageIcon(TabelaCliente.class.getResource("/com/salaodebeleza/estrutura/imagens/go-previous.png")));
		
		btnProximo = new JButton("");
		
		btnProximo.setIcon(new ImageIcon(TabelaCliente.class.getResource("/com/salaodebeleza/estrutura/imagens/go-next.png")));
		btnProximo.setToolTipText("Pr\u00F3ximo");
		
		btnUltimo = new JButton("");
		
		btnUltimo.setIcon(new ImageIcon(TabelaCliente.class.getResource("/com/salaodebeleza/estrutura/imagens/go-last.png")));
	...
	private void incluirCliente() {
		ClienteGUI usuario = new ClienteGUI(new JFrame(), true, tabelaCliente, tabelaClienteModel, 0, VariaveisProjeto.INCLUSAO);
